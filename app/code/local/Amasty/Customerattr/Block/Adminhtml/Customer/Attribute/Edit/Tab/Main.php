...
class Amasty_Customerattr_Block_Adminhtml_Customer_Attribute_Edit_Tab_Main extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('file_types', 'text', array(
            ...
            'title' => Mage::helper('amcustomerattr')->__('File Types - list comma-separated file types like: png,txt,jpg'),
            'note'  => Mage::helper('amcustomerattr')->__('List comma-separated file types like: png,txt,jpg'),
        ));
