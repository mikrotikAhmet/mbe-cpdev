...
class CpDevelopment_AdminMonitoring_Helper_Data extends Mage_Core_Helper_Abstract
{
	/**
	 * SCOPES
	 */
	...
	{
		$excludedUserIds = explode(',', Mage::getStoreConfig('admin/cpdevelopment_adminmonitoring/exclude_admin_users'));
	 ...
	 *
	 * @param  CpDevelopment_AdminMonitoring_Model_History $row
	 * @return string
	 */
	public function getRowUrl(CpDevelopment_AdminMonitoring_Model_History $row)
	{
		$transport = new Varien_Object();
		Mage::dispatchEvent('cpdevelopment_adminmonitoring_rowurl', array('history' => $row, 'transport' => $transport));
    ...
    public function getActionStatusDetails($type,$actionId){
